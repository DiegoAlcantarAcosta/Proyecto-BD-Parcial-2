...
public class PlacaDTO {
    ...
    public PlacaDTO(Calendar fechaRecepcion, String numeroAlfanumerico, Automovil automovil) {
    ...
    public String toString() {
        return "PlacaDTO{" + "fechaRecepcion=" + fechaRecepcion + ", numeroAlfanumerico=" + numeroAlfanumerico + ", automovil=" + automovil + '}';
    }
}
